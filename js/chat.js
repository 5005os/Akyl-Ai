...
(function () {
  ...
  const SYSTEM_PROMPT =
    ...
    "Если вопрос задан на кыргызском — отвечай ПОЛНОСТЬЮ на кыргызском языке, не переходи на русский " +
    "даже частично и не дублируй ответ на двух языках. Ты хорошо знаешь кыргызский язык и грамматику. " +
